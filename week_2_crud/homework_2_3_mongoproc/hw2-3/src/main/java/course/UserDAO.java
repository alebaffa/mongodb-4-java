...
public class UserDAO {
    ...
    public boolean addUser(String username, String password, String email) {
        ...
        DBObject object = new BasicDBObject("_id", username).append("password", passwordHash);


        if (email != null && !email.equals("")) {
        	((BasicDBObject) object).append("email", email);
    ...
    public DBObject validateLogin(String username, String password) {
        ...
        DBCursor object = usersCollection.find(new BasicDBObject("_id", username));
        while (object.hasNext()) {
        	DBObject temp = object.next();
			String usernameFound = (String) temp.get("_id");
